...
from project.funcs.base import load_data, split_db_2to1, vcol, vrow
...
def lab09(DATA: str):
    ...
    for C in range_c:
        scores = svm.train(C, "kernel", K=1, kernelFunc=polyKernel(2, 1))
    ...
    for l, g in gamma:
        ...
        for C in Cs:
            scores = svm.train(C, "kernel", K=1, kernelFunc=rbfKernel(g))
